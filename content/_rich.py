...
RICH_SUMMARIES = {
    ...
    "Trigeminal neuralgia": (
        ...
        "or more trigeminal divisions (V2 and V3 most common), from "
        ...
        "triggered by light touch, chewing, cold air, shaving or "
        "toothbrushing; pain-free between attacks; no sensory deficit in "
        "classical TN. "
        "Red flags for secondary cause (MS plaque, cerebellopontine angle "
        "tumour): bilateral, V1 alone, sensory loss, other cranial nerve "
        "signs, age under 40. "
        "Ix: MRI brain with dedicated trigeminal sequences to demonstrate "
        "neurovascular contact and exclude secondary cause. "
        "Mx: carbamazepine first-line (start 100 mg BD, titrate; check "
        "sodium and FBC), oxcarbazepine as alternative; add-on lamotrigine, "
        "baclofen or gabapentin; microvascular decompression (Jannetta) "
        "gives the most durable relief in fit patients; percutaneous "
        "rhizotomy or gamma knife radiosurgery for those unsuited to open "
        "surgery. "
    ...
    "Peritonsillar abscess": (
        ...
        "acute tonsillitis. "
        "Microbiology: polymicrobial - group A Streptococcus plus oral "
    ...
    "Mastitis": (
        ...
        "usually bacterial (Staphylococcus aureus entering via a nipple "
        "fissure); non-lactational mastitis is less common and includes "
        "periductal mastitis and granulomatous mastitis. "
        ...
        "recurrent, severe or MRSA-risk cases; ultrasound if abscess "
        "suspected (fluctuance, worsening despite 48 hours of oral "
        "antibiotics). "
        "Mx: continue breastfeeding or expressing from the affected side "
        "(safe for baby and clears the duct); simple analgesia, cool "
        "packs, correct latch; oral flucloxacillin 500 mg QID for 5-7 "
        "days (di/flucloxacillin per eTG), cefalexin if penicillin allergy, "
        "clindamycin if severe allergy or MRSA suspected; ultrasound-guided "
        "aspiration for abscess (repeat rather than jump to incision to "
        "preserve function); admit if septic, immunosuppressed or failing "
        "48 hours of oral therapy. "
        "Red flags: non-lactational persistent inflammatory changes over "
        "weeks, peau d'orange or nipple change - biopsy to exclude "
