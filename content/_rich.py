...
RICH_SUMMARIES = {
    ...
    "Transient tachypnea of the newborn": (
        "Delayed clearance of fetal lung fluid causing "
        "transient respiratory distress in the newborn; "
        "the commonest cause of neonatal respiratory "
        "distress. Risk factors: elective caesarean "
        "without labour, late preterm, macrosomia, "
        "maternal diabetes, maternal asthma, precipitous "
        "delivery. Clinical features: tachypnoea (over "
        "60/min), grunting, nasal flaring, mild recession "
        "and mild cyanosis within hours of birth; resolves "
        "within 24 to 72 hours. Infant otherwise appears "
        "well. Ix: clinical diagnosis of exclusion. Pulse "
        "oximetry, CXR shows perihilar streaking and "
        "fluid in fissures with hyperinflation. Exclude "
        "neonatal sepsis, meconium aspiration, RDS, "
        "pneumonia and congenital heart disease. Mx: "
        "supportive - warm environment, minimal handling, "
        "small frequent feeds or NG if tachypnoea limits "
        "oral intake, oxygen for saturation over 90%. "
        "CPAP for moderate to severe distress. Empirical "
        "antibiotics until infection excluded. Note: TTN "
        "by definition resolves within 72 hours - "
        "persistent distress means another diagnosis."
    ),
    ...
    "Pheochromocytoma": (
        ...
        "medulla chromaffin cells (extra-adrenal "
        "sympathetic paraganglia give "
        "paraganglioma). Rule of 10s: 10% extra-"
        "adrenal, 10% bilateral, 10% malignant, 10% "
        "familial, 10% in children - though "
        "familial fraction is now around 40% with "
        "expanded testing (MEN2, VHL, NF1, SDHx "
        "mutations). Clinical features: classic "
        "triad of episodic headache, palpitations "
        "and sweating; hypertension (paroxysmal or "
        "sustained); pallor, tremor, anxiety, sense "
        "of impending doom; triggers include beta-"
        "blockers alone, anaesthesia and abdominal "
        "palpation. Ix: 24-hour urinary or plasma "
        "fractionated metanephrines (higher "
        "sensitivity than catecholamines); CT or "
        "MRI adrenals to localise; MIBG or Ga-68 "
        "DOTATATE PET for extra-adrenal or "
        "metastatic disease; genetic testing in "
        "everyone. Mx: laparoscopic adrenalectomy "
        "is curative. Pre-op alpha blockade "
        "(phenoxybenzamine or doxazosin) for 10 to "
        "14 days, then beta-blocker only after "
        "alpha block is established, plus liberal "
        "salt and fluid for volume expansion. Note: "
        "hypertensive crisis needs phentolamine or "
        "sodium nitroprusside - never beta-blocker "
        "alone."
    ),
    ...
    "Peripheral artery disease": (
        ...
        "supplying the limbs (lower more than "
        "upper). Prevalence rises with age; "
        "shares risk factors with CAD - smoking "
        "(dominant), diabetes, hypertension, "
        "dyslipidaemia, CKD, age, male sex. "
        "Marker of systemic atherosclerosis - "
        "5-year cardiovascular mortality around "
        "20%. Clinical features: asymptomatic in "
        "half, intermittent claudication "
        "(reproducible calf, thigh or buttock "
        "pain on walking, relieved by rest), rest "
        "pain in critical limb ischaemia (worse "
        "lying, relieved by dependency), tissue "
        "loss, 6 Ps of acute limb ischaemia "
        "(pain, pallor, pulselessness, "
        "paraesthesia, paralysis, poikilothermia), "
        "and Leriche syndrome (aortoiliac).Ix: "
        "ABPI under 0.9 diagnostic; over 1.4 "
        "suggests incompressible vessels "
        "(diabetes, CKD). Duplex ultrasound for "
        "anatomy; CTA or MRA before intervention. "
        "Mx: risk factor modification is "
        "transformative - smoking cessation, "
        "statin, clopidogrel, BP and glycaemic "
        "control; supervised exercise programme "
        "(best evidence for claudication); "
        "cilostazol for refractory claudication. "
        "Revascularisation for critical limb "
        "ischaemia or lifestyle-limiting "
        "claudication despite optimal therapy. "
        "Note: acute limb ischaemia is a surgical "
        "emergency."
    ),
