...
RICH_SUMMARIES = {
    ...
    "Livedoid vasculopathy": (
        ...
        "the process is intraluminal thrombosis. "
        ...
        "Sjögren); the rest are idiopathic. "
        ...
        "discriminator. "
        "Ix: clinical plus skin biopsy showing hyaline fibrin thrombi "
        "without leucocytoclastic vasculitis; thrombophilia screen, ANA, "
        ...
        "as adjunct; compression; treat identified thrombophilia. "
        "Note: painful stellate white scars differentiate this from "
        "pyoderma gangrenosum, which shows pathergy and is neutrophilic "
        "on biopsy."
    ),
    ...
    "Hypereosinophilic syndrome": (
        ...
        "affected. "
        "Clinical features: cardiac symptoms (thromboembolism, heart "
        "failure), rash, wheeze, peripheral neuropathy, "
        "hepatosplenomegaly, weight loss. "
        "Ix: FBC and blood film; troponin, ECG, TTE and cardiac MRI to "
        "detect myocardial involvement early; exclude secondary causes "
        "(parasites - strongyloides serology, atopy, drugs, lymphoma, "
        "solid tumours) before labelling primary; FIP1L1-PDGFRA screen "
        "and T-cell clonality. "
        "Mx: FIP1L1-PDGFRA positive - imatinib, dramatic response at low "
        "dose; otherwise prednisolone plus a steroid-sparer "
        "(hydroxycarbamide, interferon-alpha, mepolizumab); anticoagulate "
        "mural thrombus. "
        "Note: check strongyloides serology before starting steroids - "
        "masked hyperinfection can be fatal."
    ),

    "Vulvodynia": (
        "Chronic vulvar pain of at least three months without an "
        "identifiable specific cause; multifactorial. "
        "Types: localised provoked vestibulodynia (commonest - burning at "
        "the vestibule triggered by touch, tampon or intercourse); "
        "generalised unprovoked (constant burning). "
        "Pathophysiology: peripheral sensitisation with increased "
        "C-fibre density, central sensitisation, pelvic floor "
        "hypertonicity, and psychosocial contributors. "
        "Clinical features: dyspareunia, tampon intolerance, sitting "
        "discomfort; external examination is often normal. "
        ...
        "for refractory provoked vestibulodynia with proven allodynia. "
        "Note: frequently misdiagnosed as recurrent candidiasis - absence "
        "of hyphae on microscopy and negative culture should redirect."
    ),
    ...
    "Medullary sponge kidney": (
        ...
        "Usually sporadic, occasionally familial; over-represented in "
        "Beckwith-Wiedemann and hemihypertrophy. "
        "Pathophysiology: ectatic precalyceal collecting tubules pool "
        "urine, precipitating calcium phosphate then calcium oxalate; "
        "an incomplete distal renal tubular acidosis is present in about "
        ...
        "medullary microcalcifications; non-contrast CT for acute stones; "
        "24-hour urine for calcium, oxalate, citrate and volume; morning "
        "urine pH and serum bicarbonate for RTA. "
        "Mx: high fluid intake (2 to 3 L/day); thiazide diuretic for "
        "hypercalciuria; potassium citrate for hypocitraturia or RTA; "
        "treat stones per eTG and refer for surgical clearance of "
        "obstruction. "
    ...
    "Cavernous sinus thrombosis": (
        "Thrombosis of the paired cavernous sinuses either side of the "
        "sella; septic in most cases. "
        "Causes: infection tracks from the face ('danger triangle' "
        "furuncles), sphenoid or ethmoid sinusitis, dental or middle-ear "
        "sepsis, orbital cellulitis; Staphylococcus aureus is the leading "
        "organism, streptococci and anaerobes for sinus sources. "
        "Anatomy: CN III, IV, V1, V2 and VI, and the internal carotid, "
        "all traverse the sinus - any of them may fail. "
        "Clinical features: fever, headache, systemic toxicity; painful "
        "ophthalmoplegia (CN VI first, it lies free in the lumen), "
        "proptosis, chemosis, periorbital oedema, V1/V2 sensory loss; "
        "spread to the contralateral eye through the intercavernous "
        "sinuses within 24 to 48 hours is classic. "
        "Ix: MRI with contrast plus MR venography is first-line - "
        "filling defect, sinus expansion, enlarged superior ophthalmic "
        "vein; blood cultures; identify the source (CT sinuses, dental "
        "review). "
        "Mx: empirical IV antibiotics per eTG - vancomycin plus "
        "ceftriaxone plus metronidazole for a sinus source; therapeutic "
        "heparin unless clearly contraindicated (small trials support "
        "it in septic CST); urgent ENT or neurosurgical drainage of the "
        "primary focus. "
    ...
    "Genitourinary syndrome of menopause": (
        ...
        "genitourinary changes from oestrogen loss - vulvar and vaginal "
        "atrophy, urothelial thinning, microbiome shift. "
        ...
        "(the most bothersome symptom), post-coital bleeding, discharge, "
        "vulvar burning; urinary urgency, frequency, dysuria, recurrent "
        "UTIs; unlike vasomotor symptoms it does not resolve "
        "spontaneously and worsens over time. "
        ...
        "Mx: non-hormonal first for mild symptoms - water-based "
        "lubricants for dyspareunia, hyaluronic acid moisturisers used "
        "several times a week; low-dose vaginal oestrogen is first-line "
        "pharmacotherapy (Ovestin cream, Vagifem pessaries, oestriol "
        "ring) - highly effective with negligible systemic absorption "
        "and, in consultation with oncology, generally acceptable after "
        "breast cancer; systemic MHT if vasomotor symptoms also warrant "
        "it; oral ospemifene or vaginal prasterone as alternatives. "
        "Note: vaginal oestrogen dose does not raise serum levels "
        "meaningfully - progestogen opposition is not required."
    ),

    "Altitude sickness": (
        "Spectrum of hypobaric hypoxic illness on rapid ascent above "
        "about 2500 m, ranging from acute mountain sickness to "
        "life-threatening cerebral or pulmonary oedema. "
        "Pathophysiology: reduced inspired PO2 triggers hypoxic "
        "pulmonary vasoconstriction and cerebral vasodilation; HAPE - "
        "uneven vasoconstriction with endothelial leak, non-cardiogenic "
        "pulmonary oedema; HACE - vasogenic cerebral oedema. "
        "Clinical features: AMS - headache plus nausea, fatigue, "
        "dizziness or disturbed sleep, developing 6 to 12 hours after "
        "ascent (Lake Louise score); HAPE - dyspnoea at rest, cough "
        "with pink frothy sputum, hypoxia, crackles; HACE - ataxia, "
        "altered consciousness, focal signs; symptoms worsen on further "
        "ascent. "
        "Ix: clinical; SpO2 falls further than expected for altitude in "
        "HAPE and HACE; imaging only for confounders. "
        "Mx: mild AMS - halt ascent, analgesia, acetazolamide 250 mg BD; "
        "moderate to severe AMS or any HAPE/HACE - immediate descent "
        "(the definitive treatment), supplemental oxygen, portable "
        "hyperbaric bag if descent is delayed; add dexamethasone 4 mg "
        "6-hourly for HACE, nifedipine or a PDE-5 inhibitor for HAPE. "
        "Prevention: gradual ascent (below 500 m sleeping-altitude gain "
        "per day above 3000 m, rest day every third day); acetazolamide "
        "prophylaxis for rapid ascent or prior AMS. "
        "Note: descent trumps every drug - do not wait for evacuation to "
    ...
    "Takayasu arteritis": (
        ...
        "Pathophysiology: transmural inflammation drives concentric wall "
        "thickening, then stenosis, occlusion or aneurysm; subclavian "
        ...
        "renovascular hypertension, angina, TIA); many patients present "
        "already in the vascular phase. "
        "Ix: ESR and CRP elevated but often normal in burnt-out disease; "
        "MRA of aorta and branches is diagnostic - circumferential wall "
        "thickening and stenoses; PET-CT for activity assessment when "
        "MRA is equivocal; angiography reserved for planning "
        "intervention. "
        "Mx: high-dose prednisolone (1 mg/kg) with an early steroid-"
        "sparing agent (methotrexate, azathioprine or mycophenolate); "
        "tocilizumab for refractory disease; treat hypertension and "
        "cardiovascular risk factors; revascularisation for symptomatic "
        "critical stenosis only in the quiescent phase - intervention on "
        "active disease restenoses rapidly. "
        "Note: normal inflammatory markers do not exclude active disease "
        "- imaging with wall enhancement is more reliable."
    ),
    ...
    "Internuclear ophthalmoplegia": (
        ...
        "CN VI nucleus and the contralateral CN III nucleus. Convergence "
        "is preserved, which separates INO from a third nerve palsy. "
        "Causes: bilateral INO in a young adult is essentially MS until "
        "proven otherwise; unilateral INO in an older patient is usually "
        "a small brainstem lacunar infarct; also brainstem tumour, "
        "Wernicke, neurosarcoid, neurosyphilis, Lyme, drug toxicity. "
        "Clinical features: on H-pattern pursuit the adducting eye lags "
        "or fails to cross the midline while the abducting eye jerks "
        "outward; diplopia on lateral gaze; convergence intact. "
        "One-and-a-half syndrome adds an ipsilateral gaze palsy (PPRF "
        "plus MLF lesion). "
        "Ix: MRI brain with attention to the dorsal pontine tegmentum; "
        "if MS suspected, add contrast, spinal cord imaging and consider "
        "CSF (oligoclonal bands, raised IgG index); B12 and thiamine as "
        "relevant. "
        "Mx: treat the underlying cause - high-dose methylprednisolone "
        "for MS relapse, stroke workup and secondary prevention for "
        "infarct, thiamine for Wernicke; the ocular deficit usually "
        "improves as the lesion resolves. "
        "Note: bilateral INO in a young woman is an MS presentation "
        "until MRI says otherwise."
    ),

    "Retropharyngeal abscess": (
        "Suppurative collection in the retropharyngeal space, between "
        "the posterior pharyngeal wall and the prevertebral fascia. "
        "Epidemiology: children under 5 predominantly - the "
        "retropharyngeal lymph nodes regress by that age, and infection "
        "tracks from upper respiratory or otitis-related lymphadenitis; "
        "in adults it follows penetrating trauma (fish bone, endoscopy, "
        "intubation) or extension from vertebral osteomyelitis. "
        "Organisms: Group A Streptococcus, Staphylococcus aureus "
        "(including MRSA), oral anaerobes; often polymicrobial. "
        "Clinical features: fever, neck pain and stiffness, dysphagia "
        "and drooling, muffled 'hot potato' voice, torticollis with "
        "extended neck (children adopt this to widen the space), "
        "trismus; stridor is late and signals impending airway loss. "
        "Complications: airway obstruction, extension through the "
        "'danger space' to the mediastinum (descending necrotising "
        "mediastinitis, highest mortality), Lemierre syndrome. "
        "Ix: lateral soft-tissue neck X-ray shows prevertebral widening "
        "(over 7 mm at C2, over 14 mm at C6 in adults); CT neck with "
        "contrast is the gold standard - separates phlegmon from a "
        "drainable collection and maps spread. "
        "Mx: airway takes priority - senior anaesthetic input, ready to "
        "intubate or perform tracheostomy; IV antibiotics per eTG "
        "(amoxicillin-clavulanate, or clindamycin plus a third-"
        "generation cephalosporin if severe; add vancomycin for MRSA "
        "risk); ENT-led drainage (transoral for small collections, "
        "external approach if extension); ICU-level monitoring. "
        "Red flags: stridor, tripod posture or drooling with any "
        "suspicion mandate airway control before imaging."
    ),
}
