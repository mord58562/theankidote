...
RICH_SUMMARIES = {
    ...
    "Postpartum haemorrhage": (
        ...
        "massive-transfusion protocol; empty the bladder. Uterotonics "
        "in sequence: IV oxytocin (bolus then infusion), IM ergometrine "
        "(avoid in hypertension), IM carboprost (avoid in asthma), "
        "misoprostol per rectum. Tranexamic acid 1 g IV within 3 hours "
    ...
    "Tuberculosis": (
        ...
        "visual acuity. Latent TB: isoniazid for 6 to 9 months, or "
