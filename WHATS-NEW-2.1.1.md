# What's new in The AnkiDote 2.1.1

A small release on top of 2.1, and mostly one thing: drugs written the
way Australians write them now actually highlight.
...
## Five drugs were shown under their American name
...
written the American way still work; they just display the Australian
name now. Nitroglycerin, which had no Australian counterpart in the
database at all, is now glyceryl trinitrate.

## Twelve more conditions rewritten

Amenorrhoea, rheumatic heart disease, diverticular disease, cerebral
venous sinus thrombosis, haemorrhoids, acute angle-closure glaucoma,
osteomalacia, rickets, anal fissure, uveitis, Huntington disease and
chronic fatigue syndrome.

Chosen the same way as every batch before them: by how often each
actually comes up, not by how badly each overflowed.
